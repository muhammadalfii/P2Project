(function($) {
  ...
  $(function() {
    ...
    if ($("#north-america-chart").length) {
      var areaData = {
        labels: ["Jumlah Pasien", "Total Pemasukan", "Waktu Tindakan"],
        datasets: [{
            data: [50, 30, 20],
            backgroundColor: [
      ...
      var areaOptions = {
        ...
        legendCallback: function(chart) { 
          ...
          text.push('<div class="report-chart">');
            text.push('<div class="d-flex justify-content-between mx-6 mx-xl-6 ml-4 mt-4"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[0] + '"></div><p class="mb-0">Rata-rata Menangani Pasien<br>1.500 Pasien</p></div>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-6 mx-xl-6 ml-4 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[1] + '"></div><p class="mb-0">Rata-rata Total Pemasukan<br>Rp 5.000.000</p></div>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-6 mx-xl-6 ml-4 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[2] + '"></div><p class="mb-0">Rata-rata Waktu Tindakan<br>45 Menit</p></div>');
            text.push('</div>');
          text.push('</div>');
          return text.join("");
        },
