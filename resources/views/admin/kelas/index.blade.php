              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <h3><i class="mdi mdi-view-list"></i> List Data Kelas</h3>
                    <a href="/admin/kelas/add">
                  ...
                  <div class="table-responsive">
                    <table id="example1" class="display expandable-table" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <?php
                          $jurusan= DB::table('jurusan')->find($data->id);
                        ?>  
                        <tr class="odd selected">
                          ...
                          <td class="text-center">
                            <a href="/admin/kelas/edit/{{$data->id}}"><button class="btn btn-inverse-success btn-sm"><i class="ti-pencil"> Edit</i></button></a>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-body">
                ...
                <div class="row mt-1">
                  <div class="col-md-6">
                    <a href="/admin/kelas/delete/{{$data->id}}" style="text-decoration: none;">
