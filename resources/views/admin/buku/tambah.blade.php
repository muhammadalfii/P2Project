              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <h3><i class="mdi mdi-library-plus"></i>Tambah Data Buku</h3>
                    <a href="/admin/buku">
                      <button type="button" class="btn btn-inverse-info btn-rounded btn-sm"><i class="ti-arrow-left mr-1"></i>Back</button>
                    </a>
                  </div>
                  <hr>
                  <form class="forms-sample" action="/admin/buku/create" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                      <div class="col-md-6 mb-4">
                        <label for="exampleInputUsername1">Nama Buku</label>
                        <input type="text" autofocus required class="form-control" name="nama" placeholder="Masukan Nama Buku...">
                      </div>

                      <div class="col-md-6 mb-4">
                          <label for="exampleInputUsername1">Penerbit</label>
                          <input type="text" autofocus required class="form-control" name="penerbit" placeholder="Masukan Penerbit...">
                      </div>

                      <div class="col-md-6 mb-4">
                          <label for="exampleInputUsername1">Pengarang</label>
                          <input type="text" autofocus required class="form-control" name="pengarang" placeholder="Masukan Pengarang...">
                      </div>


                      <div class="col-md-6 mb-4">
                          <label for="exampleInputUsername1">Tahun Terbit</label>
                          <input type="text" autofocus required class="form-control" name="tahun_terbit" placeholder="Masukan Tahun Terbit...">
                      </div>

                      <div class="col-md-6 mb-4">
                          <label for="exampleInputUsername1">Stock</label>
                          <input type="text" autofocus required class="form-control" name="stock" placeholder="Masukan Stock...">
                      </div>
