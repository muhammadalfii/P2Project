              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <h3><i class="mdi mdi-view-list"></i> List Data Semester</h3>
                    <a href="/admin/semester/add">
                      ...
                      <tbody>
                        ...
                        <tr class="odd selected">
                          ...
                          <td class="text-center">
                            <a href="/admin/semester/edit/{{$data->id}}"><button class="btn btn-inverse-success btn-sm"><i class="ti-pencil"> Edit</i></button></a>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-body">
                ...
                <div class="row mt-1">
                  <div class="col-md-6">
                    <a href="/admin/semester/delete/{{$data->id}}" style="text-decoration: none;">
