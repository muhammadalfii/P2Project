            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Data Semester</h6>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <h3><i class="ti-pencil"></i> Edit Data Semester</h3>
                  ...
                  <hr>
                  <form class="forms-sample" action="/admin/semester/update/{{$semester->id}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                      <label for="exampleInputUsername1">Nama Semester</label>
                      <input type="text" autofocus required class="form-control" name="nama" placeholder="Masukan Nama semester..." value="{{$semester->nama}}">
                    </div>
