              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <h3><i class="mdi mdi-view-list"></i> List Data Pengembalian</h3>
                    <a href="/admin/pengembalian/add">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-body">
                ...
                <div class="row mt-1">
                  <div class="col-md-6">
                    <a href="/admin/pengembalian/delete/{{$data->id}}" style="text-decoration: none;">
