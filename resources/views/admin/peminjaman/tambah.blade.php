              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <h3><i class="mdi mdi-library-plus"></i>Tambah Data Peminjaman</h3>
                  ...
                  <hr>
                  <form class="forms-sample" action="/admin/peminjaman/create" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
